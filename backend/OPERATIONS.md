...
2. `NEO4J_URI`, `NEO4J_USER`, `NEO4J_PASSWORD`, `NEO4J_DATABASE`
3. `NEO4J_INIT_ON_STARTUP`, `NEO4J_ASSETS_PATH`
4. `AI_PROVIDER`, `AI_API_KEY`, `AI_MODEL`
5. `AI_TIMEOUT_SECONDS`, `AI_MAX_RETRIES`, `AI_RETRY_BACKOFF_SECONDS`, `AI_RETRY_MAX_BACKOFF_SECONDS`
6. `AI_SIMILAR_CASES_LIMIT`
